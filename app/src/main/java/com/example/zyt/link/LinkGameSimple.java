...
public class LinkGameSimple extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linkgamesimple);
        timer = findViewById(R.id.chronometer_1);
            ...
            if (secondClick != R.drawable.blank && lastClicked != position) {
                ...
                if (firstClick == 0) {
                    ...
                    if (secondClick == firstClick) {
                        //生成坐标-->
                        Game.Point thisPoint = positionToPoint(position,4);
                        Game.Point lastPoint = positionToPoint(lastClicked,4);
                        //判断能否被删除-->
                        if (checkIsItCanBeDestroyed(thisPoint, lastPoint, dataList,4)) {
