...
public class LinkGameMedium extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linkgamemedium);
        timer = findViewById(R.id.chronometer_2);
        gridView = findViewById(R.id.gridView_2);
        dataList = new ArrayList<>();
        saveButton = findViewById(R.id.saveButton_2);
            ...
            if (secondClick != R.drawable.blank && lastClicked != position) {
                ...
                if (firstClick == 0) {
                    ...
                    if (secondClick == firstClick) {
                        //生成坐标-->
                        Game.Point thisPoint = positionToPoint(position,6);
                        Game.Point lastPoint = positionToPoint(lastClicked,6);
                        //判断能否被删除-->
                        if (checkIsItCanBeDestroyed(thisPoint, lastPoint, dataList,6)) {
